...
router.put('/actualizar/:seg_id', sessionMiddleware, authMiddleware, checkRol([5]), upload.single('seg_foto'), validarUpdateSeguimiento, actualizarSeguimientoPaciente);
